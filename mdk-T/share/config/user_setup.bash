...
export MIRO_ROS_RELEASE=${MIRO_ROS_RELEASE-noetic}
...
# MIRO_WEB_PASSPHRASE
#
# Requests sent to MIRO's web servers will be decrypted using this
# passphrase, so it must be used also at the encoding end.
#
# NB: If empty, the value 'miro web passphrase' is assumed.
export MIRO_WEB_PASSPHRASE=
