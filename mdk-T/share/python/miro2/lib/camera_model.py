...
class CameraModel:
	...
	def __init__( self, pars=None, verbose=True ):

		if pars is None:
			# use default if not supplied
			pars = miro.lib.platform_pars.PlatformPars()
	...
	def vh2oh(self, stream_index, vh, r):
		...
		o = [r, 0.0, 0.0]
		o = miro.lib.kc.kc_rotate(o, 'z', vh.azim)
		o = miro.lib.kc.kc_rotate(o, 'y', -vh.elev)
