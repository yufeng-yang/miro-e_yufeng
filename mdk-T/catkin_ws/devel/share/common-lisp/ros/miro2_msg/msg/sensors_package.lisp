...
(cl:defclass <sensors_package> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (battery
    :reader battery
    :initarg :battery
    :type miro2_msg-msg:BatteryState
    :initform (cl:make-instance 'miro2_msg-msg:BatteryState))
   (cliff
    :reader cliff
    :initarg :cliff
