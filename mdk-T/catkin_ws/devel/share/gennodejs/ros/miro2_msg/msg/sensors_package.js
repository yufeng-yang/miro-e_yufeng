...
class sensors_package {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BatteryState.serialize(obj.battery, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.battery = BatteryState.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += BatteryState.getMessageSize(object.battery);
  ...
  static Resolve(msg) {
    ...
    if (msg.battery !== undefined) {
      resolved.battery = BatteryState.Resolve(msg.battery)
    }
    else {
      resolved.battery = new BatteryState()
    }
